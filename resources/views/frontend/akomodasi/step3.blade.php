        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><b>Total Harga: </b>Rp{{ number_format($request->total_price, 0, ',', '.') }}</p>
                    <p><b>Uang Muka (50%): </b>Rp{{ number_format($request->total_price * 0.5, 0, ',', '.') }}</p>
                    ...
                    <form id="bookingForm" action="{{ route('booking.submit') }}" method="POST"
                        ...
                        <div style="display: none;">
                            <input type="text" name="id_user" value="{{ Auth::check() ? Auth::user()->id : '' }}">
                            <input type="text" name="tanggal_checkin" value="{{ $request->check_in_date }}">
                            <input type="text" name="tanggal_checkout" value="{{ $request->check_out_date }}">
                            <input type="text" name="total_harga" value="{{ $request->total_price }}">
                            <input type="text" name="min_dp" value="{{ $request->total_price * 0.5 }}">
                            <input type="text" name="id_no_kamar" value="{{ $selectedRoom->id_no_kamar }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <p class="text-center mb-4">Silakan lakukan pembayaran atau DP sebesar <strong>30%</strong> ke
                            nomor
                            BRIVA di atas.</p>
